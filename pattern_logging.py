...
"""
Part of the pattern calculator for Drakor. See pattern.py for function
naming rules.
"""

from math import ceil   #for multi-output rounding
from pattern_tree import build_tree  #for building the pattern tree
...
def chestnut(quantity=1, indent=0):
    build_tree("Chestnut", quantity, indent)
...
def red_balloon(quantity=1, indent=0):
    build_tree("Red Balloon", quantity, indent)
...
def strawberry_syrup(quantity=1, indent=0):
    build_tree("Strawberry Syrup", quantity, indent)
